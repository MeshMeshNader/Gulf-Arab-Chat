package com.gulf.arabchat.authUtils;
...
/**
 * Configurations for the ArabChatLoginActivity.
 */
public class ArabChatLoginConfig {
    private static final String APP_LOGO = "ArabChatLogin.APP_LOGO";
    private static final String PARSE_LOGIN_ENABLED = "ArabChatLogin.PARSE_LOGIN_ENABLED";
    private static final String PARSE_LOGIN_BUTTON_TEXT = "ArabChatLogin.PARSE_LOGIN_BUTTON_TEXT";
    private static final String PARSE_SIGNUP_BUTTON_TEXT = "ArabChatLogin.PARSE_SIGNUP_BUTTON_TEXT";
    private static final String PARSE_LOGIN_HELP_TEXT = "ArabChatLogin.PARSE_LOGIN_HELP_TEXT";
    private static final String PARSE_LOGIN_INVALID_CREDENTIALS_TOAST_TEXT = "ArabChatLogin.PARSE_LOGIN_INVALID_CREDENTIALS_TEXT";
    private static final String PARSE_LOGIN_EMAIL_AS_USERNAME = "ArabChatLogin.PARSE_LOGIN_EMAIL_AS_USERNAME";
    private static final String PARSE_SIGNUP_MIN_PASSWORD_LENGTH = "ArabChatLogin.PARSE_SIGNUP_MIN_PASSWORD_LENGTH";
    private static final String PARSE_SIGNUP_SUBMIT_BUTTON_TEXT = "ArabChatLogin.PARSE_SIGNUP_SUBMIT_BUTTON_TEXT";
    private static final String PARSE_SIGNUP_NAME_FIELD_ENABLED = "ArabChatLogin.PARSE_SIGNUP_NAME_FIELD_ENABLED";
    private static final String FACEBOOK_LOGIN_ENABLED = "ArabChatLogin.FACEBOOK_LOGIN_ENABLED";
    private static final String FACEBOOK_LOGIN_BUTTON_TEXT = "ArabChatLogin.FACEBOOK_LOGIN_BUTTON_TEXT";
    private static final String FACEBOOK_LOGIN_PERMISSIONS = "ArabChatLogin.FACEBOOK_LOGIN_PERMISSIONS";
    private static final String TWITTER_LOGIN_ENABLED = "ArabChatLogin.TWITTER_LOGIN_ENABLED";
    private static final String TWITTER_LOGIN_BUTTON_TEXT = "ArabChatLogin.TWITTER_LOGIN_BUTTON_TEXT";

    // For internally serializing to/from string array (the public analog above is for resource from activity meta-data).
    private static final String FACEBOOK_LOGIN_PERMISSIONS_STRING_ARRAY = "ArabChatLogin.FACEBOOK_LOGIN_PERMISSIONS_STRING_ARRAY";

    private static final String LOG_TAG = "com.parse.ui.ArabChatLoginConfig";
    ...
    /**
     * Constructs a ArabChatLoginConfig object from a bundle. Unrecognized keys are
     * ignored.
     * <p>
     * This can be used to pass an ArabChatLoginConfig object between activities, or
     * to read settings from an activity's meta-data in Manefest.xml.
     *
     * @param bundle
     *     The Bundle representation of the ArabChatLoginConfig object.
     * @param context
     *     The context for resolving resource IDs.
     * @return The ArabChatLoginConfig instance.
     */
    @SuppressLint("LongLogTag")
    public static ArabChatLoginConfig fromBundle(Bundle bundle, Context context) {
        ArabChatLoginConfig config = new ArabChatLoginConfig();
