...
import com.gulf.arabchat.auth.ForgotFragment;
import com.gulf.arabchat.auth.LoginFragment;
import com.gulf.arabchat.auth.SignupFragment;
...
public class ArabChatSignupActivity extends AppCompatActivity implements
    ...
    public static final String LOG_TAG = "ArabChatSignupActivity";
    ...
    private Bundle getMergedOptions() {
        ...
        // The options specified in the Intent (from ArabChatLoginBuilder) will
