...
public class ArabChatLoginBuilder {

    private Context context;
    private ArabChatLoginConfig config = new ArabChatLoginConfig();

    public ArabChatLoginBuilder(Context context) {
     ...
     */
    public ArabChatLoginBuilder setAppLogo(int id) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setParseLoginEnabled(boolean enabled) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setParseLoginButtonText(CharSequence text) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setParseLoginButtonText(int id) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setParseSignupButtonText(CharSequence text) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setParseSignupButtonText(int id) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setParseLoginHelpText(CharSequence text) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setParseLoginHelpText(int id) {
     ...
     * @return The caller instance to allow chaining.
     */
    private ArabChatLoginBuilder setParseLoginInvalidCredentialsToastText(
            CharSequence text) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setParseLoginInvalidCredentialsToastText(int id) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setParseLoginEmailAsUsername(boolean emailAsUsername) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setParseSignupMinPasswordLength(int minPasswordLength) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setParseSignupSubmitButtonText(CharSequence text) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setParseSignupSubmitButtonText(int id) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setParseSignupNameFieldEnabled(boolean enabled) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setFacebookLoginEnabled(boolean enabled) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setFacebookLoginButtonText(CharSequence text) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setFacebookLoginButtonText(int id) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setFacebookLoginPermissions(
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setTwitterLoginEnabled(boolean enabled) {
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setTwitterLoginButtontext(
     ...
     * @return The caller instance to allow chaining.
     */
    public ArabChatLoginBuilder setTwitterLoginButtontext(int id) {
        config.setTwitterLoginButtonText(maybeGetString(id));
        return this;
    }

    /**
     * Construct an intent that can be used to start ArabChatLoginActivity with the
     * specified customizations.
     *
     * @return The intent for starting ArabChatLoginActivity
     */
    public Intent build() {
        Intent intent = new Intent(context, ArabChatLoginActivity.class);
