...
public class SendNotifications {
    ...
    public static final String PUSH_TYPE_ARABCHAT_LIVE = "ARABCHAT_LIVE";
    ...
    public static void SendPush(User fromUser, User toUser, String type, String message){
        ...
        if (type.equals(PUSH_TYPE_MESSAGES) && toUser.getPushNotificationsMassagesEnabled()){
        ...
        } else if (type.equals(PUSH_TYPE_ARABCHAT_LIVE) && toUser.getPushNotificationsLiveEnabled()){
            ...
            params.put(PUSH_NOTIFICATION_TYPE, PUSH_TYPE_ARABCHAT_LIVE);
