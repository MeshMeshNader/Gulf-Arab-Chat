package com.gulf.arabchat0.models.arabchat;
...
public class User extends ParseUser {
    ...
    private static final String PUSH_NOTIFICATIONS_ARABCHAT_LIVE = "pushLive";
    ...
    public void setPushNotificationsLiveDisabled(boolean notificationsProfileVisitorDisabled){
        put(PUSH_NOTIFICATIONS_ARABCHAT_LIVE, notificationsProfileVisitorDisabled);
    }

    public boolean getPushNotificationsLiveEnabled(){
        return !this.getBoolean(PUSH_NOTIFICATIONS_ARABCHAT_LIVE);
    }
