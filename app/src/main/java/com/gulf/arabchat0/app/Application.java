...
import com.gulf.arabchat0.models.arabchat.CallsModel;
import com.gulf.arabchat0.models.arabchat.FollowModel;
...
import com.gulf.arabchat0.utils.rtcUtils.AGEventHandler;
import com.gulf.arabchat0.utils.rtcUtils.WorkerThread;
...
import com.gulf.arabchat0.models.arabchat.ReportModel;
import com.gulf.arabchat0.utils.FontsOverride;
...
import static com.gulf.arabchat0.app.Constants.LOG_TAG;
    ...
    public void updateTimeOnline(User user) {
        ...
        if (user != null){
            ...
            user.saveInBackground(e -> {
                if (e != null){
                    QuickHelp.logoutForInvalidSession(e);
                }
            });
