...
public class OwnProfileSmallPhotosAdapter extends RecyclerView.Adapter<OwnProfileSmallPhotosAdapter.ViewHolder>{
    private User mUser;
    private List<ParseFile> parseFiles;
    private Activity mActivity;


    public OwnProfileSmallPhotosAdapter(Activity activity, List<ParseFile> parseFileList, User user) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.list_item_my_profile_small_photo, parent, false);
        return new OwnProfileSmallPhotosAdapter.ViewHolder(view);
    }
