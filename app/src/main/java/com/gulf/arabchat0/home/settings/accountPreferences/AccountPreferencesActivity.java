    ...
    public void goToInvisibleMode(){
        ...
        if (Config.isPremiumEnabled){
            ...
            if (mCurrentUser.isPremium()){
                ...
                QuickHelp.goToActivityWithNoClean(this, PaymentsActivity.class, PaymentsActivity.ARABCHAT_PAYMENT_TYPE, PaymentsActivity.TYPE_ARABCHAT_PREMIUM, PaymentsActivity.ARABCHAT_PREMIUM_TYPE, PaymentsActivity.TYPE_ARABCHAT_PREMIUM_INCOGNITO);
            }
