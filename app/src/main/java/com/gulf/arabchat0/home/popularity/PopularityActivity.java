package com.gulf.arabchat0.home.popularity;
...
public class PopularityActivity extends AppCompatActivity {
    ...
    ImageView mGetFreeCreditsImg, mRiseUpImg, mGetMoreVisitsImg, mAddExtraShowsImg, mGetARABCHATPremiumImg, mShowImOnlineImg, mGet3xMorePopularImg;
    AppCompatButton mGetFreeCreditsBtn, mRiseUpBtn, mGetMoreVisitsBtn, mAddExtraShowsBtn, mGetARABCHATPremiumBtn, mShowImOnlineBtn, mGet3xMorePopularBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGetARABCHATPremiumImg = findViewById(R.id.get_arabchat_premium_rv_image);
        ...
        mGetARABCHATPremiumBtn = findViewById(R.id.get_arabchat_premium_rv_button);
        ...
        mGetARABCHATPremiumBtn.setOnClickListener(v -> goToPurchasePremium());
        ...
        if (mCurrentUser != null){
            ...
            if (mCurrentUser.getProfilePhotos().size() == 0){
                ...
                QuickHelp.getAvatar(mGetARABCHATPremiumImg, mCurrentUser);
                ...
                QuickHelp.getAvatar(mGetARABCHATPremiumImg, mCurrentUser, 0);
                ...
                QuickHelp.getAvatar(mGetMoreVisitsImg, mCurrentUser, 1);
                QuickHelp.getAvatar(mAddExtraShowsImg, mCurrentUser, 2);
                QuickHelp.getAvatar(mGetARABCHATPremiumImg, mCurrentUser, 3);
                QuickHelp.getAvatar(mShowImOnlineImg, mCurrentUser, 0);
                QuickHelp.getAvatar(mGet3xMorePopularImg, mCurrentUser, 0);
            ...
            if (mCurrentUser.isPremiumLifeTime()){
                mGetARABCHATPremiumBtn.setEnabled(false);
                mGetARABCHATPremiumBtn.setTextSize(15);
                mGetARABCHATPremiumBtn.setText(getString(R.string.lifetime));
            } else if (mCurrentUser.getPremium() != null && new Date().before(mCurrentUser.getPremium())){
                mGetARABCHATPremiumBtn.setEnabled(false);
                mGetARABCHATPremiumBtn.setTextSize(15);
                mGetARABCHATPremiumBtn.setText(String.format("%s: %s", getString(R.string.active_until), QuickHelp.getDateFormat(mCurrentUser.getPremium())));
            } else {
                mGetARABCHATPremiumBtn.setEnabled(true);
            }
    ...
    public void goToPurchase(String type){
        ...
        } else QuickHelp.goToActivityWithNoClean(this, PaymentsActivity.class, PaymentsActivity.ARABCHAT_PAYMENT_TYPE, type);

    }

    public void goToPurchasePremium(){

        QuickHelp.goToActivityWithNoClean(this, PaymentsActivity.class, PaymentsActivity.ARABCHAT_PAYMENT_TYPE, PaymentsActivity.TYPE_ARABCHAT_PREMIUM, PaymentsActivity.ARABCHAT_PREMIUM_TYPE, PaymentsActivity.ARABCHAT_PREMIUM_TYPE);
