package com.gulf.arabchat0.home.settings.accountPreferences;
...
public class SettingsNotificationsActivity extends AppCompatActivity {
    ...
    SwitchCompat mMessages, mMatches, mLikedYou, mProfileVisitor, mFavoritedYou, mARABCHATLive;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mARABCHATLive = findViewById(R.id.noti_arabchat_live);
        ...
        if (mCurrentUser != null){
            ...
            if (mCurrentUser.getPushNotificationsLiveEnabled()){
                mARABCHATLive.setChecked(true);
            } else {
                mARABCHATLive.setChecked(false);
            }
        }
        ...
        mARABCHATLive.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked){
