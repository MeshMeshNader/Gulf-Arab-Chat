package com.gulf.arabchat0.home.nearby;
...
import com.gulf.arabchat0.adapters.others.PlacesListAdapter;
import com.gulf.arabchat0.helpers.QuickHelp;
import com.gulf.arabchat0.models.others.PlacesModel;
    ...
    public void getPlaces(String queryText){
        ...
        mPlacesClient.findAutocompletePredictions(request).addOnSuccessListener(response -> {
            ...
            if (exception instanceof ApiException) {
                ...
                Log.e("ARABCHAT_LOCATION", exception.getLocalizedMessage() + " " + apiException.getStatusCode());
