...
import com.gulf.arabchat0.modules.expansionpanel.ExpansionLayout;
        ...
        mLikesLayout.setOnClickListener(v -> {
            ...
            if (Config.isPremiumEnabled){
                ...
                if (mCurrentUser.isPremium()){
                    ...
                    QuickHelp.goToActivityWithNoClean(getActivity(), PaymentsActivity.class, PaymentsActivity.ARABCHAT_PAYMENT_TYPE, PaymentsActivity.TYPE_ARABCHAT_PREMIUM, PaymentsActivity.ARABCHAT_PREMIUM_TYPE, PaymentsActivity.TYPE_ARABCHAT_PREMIUM_LIKED);
                }
