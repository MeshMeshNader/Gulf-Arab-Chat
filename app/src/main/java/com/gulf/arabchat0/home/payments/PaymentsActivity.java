...
public class PaymentsActivity extends AppCompatActivity implements PaymentProductListSkuAdapter.ItemViewHolder.OnItemSelectedListener, PurchasesUpdatedListener {
    ...
    public static String ARABCHAT_PAYMENT_TYPE = "PAYMENT_TYPE";
    public static String ARABCHAT_PREMIUM_TYPE = "PREMIUM_TYPE";
    public static String ARABCHAT_CRUSH_USER = "CRUSH_USER";

    public static String TYPE_ARABCHAT_PREMIUM = "ARABCHAT_PREMIUM";
    public static String TYPE_ARABCHAT_PREMIUM_LIKED = "ARABCHAT_PREMIUM_LIKED";
    public static String TYPE_ARABCHAT_PREMIUM_UNDO = "ARABCHAT_PREMIUM_UNDO";
    public static String TYPE_ARABCHAT_PREMIUM_INCOGNITO = "ARABCHAT_PREMIUM_INCOGNITO";
    public static String TYPE_ARABCHAT_PREMIUM_MESSAGES = "ARABCHAT_PREMIUM_MESSAGES";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mType = getIntent().getStringExtra(ARABCHAT_PAYMENT_TYPE);
        mPremiumType = getIntent().getStringExtra(ARABCHAT_PREMIUM_TYPE);

        mUser = getIntent().getParcelableExtra(ARABCHAT_CRUSH_USER);
